...
export const KES_COPY: Record<Language, KesCopy> = {
  ...
  ledger: {
    ...
    since: (d) => `Depuis le ${d}`,
    unavailable: "La caisse sera disponible après la mise à jour de la base (migration 6).",
    forbidden: "Seul le propriétaire voit la caisse.",
    cards: {
      cashIn: "Encaissé",
      expenses: "Dépenses",
    ...
    receivables: {
      title: "Argent dehors (à encaisser)",
