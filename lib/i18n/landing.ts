...
const fr: LandingCopy = {
  ...
  footer: {
    ...
    companyLinks: ["Tarifs", "Contact", "Conditions"],
...
const ht: LandingCopy = {
  ...
  footer: {
    ...
    companyLinks: ["Pri", "Kontak", "Kondisyon"],
    rights: "© 2026 CONVERZA",
...
const en: LandingCopy = {
  ...
  pricing: {
    ...
    plans: [
      ...
      },
      {
        name: "Premium",
        price: "2 500",
        features: ["Everything in Pro", "Unlimited team accounts", "Stock management assistant", "Order notifications"],
      },
    ],
  },
  faq: {
  ...
  footer: {
    ...
    companyLinks: ["Pricing", "Contact", "Terms"],
    rights: "© 2026 CONVERZA",
