...
const fr: StorefrontCopy = {
  ...
  sectors: {
    ...
    immobilier: { label: "Immobilier", catalog: "Biens disponibles" },
    automobile: { label: "Automobile", catalog: "Pièces et véhicules" },
    sante_bienetre: { label: "Santé et bien-être", catalog: "Soins et services" },
    beaute_services: { label: "Beauté", catalog: "Prestations" },
    education: { label: "Éducation", catalog: "Formations" },
    services_pros: { label: "Services professionnels", catalog: "Services" },
    construction: { label: "Construction", catalog: "Projets et matériaux" },
    digital_tech: { label: "Digital", catalog: "Services" },
    grossistes_distribution: { label: "Grossiste", catalog: "Catalogue en gros" },
  },
  message: {
...
const ht: StorefrontCopy = {
  ...
  sectors: {
    ...
    immobilier: { label: "Imobilye", catalog: "Kay ak tè disponib" },
    automobile: { label: "Oto", catalog: "Pyès ak machin" },
    sante_bienetre: { label: "Sante ak byennèt", catalog: "Swen ak sèvis" },
    beaute_services: { label: "Bote", catalog: "Sèvis" },
    education: { label: "Edikasyon", catalog: "Fòmasyon" },
    services_pros: { label: "Sèvis pwofesyonèl", catalog: "Sèvis" },
    construction: { label: "Konstriksyon", catalog: "Pwojè ak materyo" },
    digital_tech: { label: "Dijital", catalog: "Sèvis" },
    grossistes_distribution: { label: "Machann an gwo", catalog: "Katalòg an gwo" },
  },
  message: {
...
const en: StorefrontCopy = {
  ...
  sectors: {
    ...
    immobilier: { label: "Real estate", catalog: "Available properties" },
    automobile: { label: "Automotive", catalog: "Parts and vehicles" },
    sante_bienetre: { label: "Health and wellness", catalog: "Care and services" },
    beaute_services: { label: "Beauty", catalog: "Services" },
    education: { label: "Education", catalog: "Courses" },
    services_pros: { label: "Professional services", catalog: "Services" },
    construction: { label: "Construction", catalog: "Projects and materials" },
    digital_tech: { label: "Digital", catalog: "Services" },
    grossistes_distribution: { label: "Wholesale", catalog: "Wholesale catalogue" },
  },
  message: {
